...
public class ChineseDynasties {
    ...
    private static Object[] Dynastys() {
        ...
        int totalAttackLi = powerWarrior * numbersOfWarriors + powerArcher * numbersOfWarriors + powerHorseman * numbersOfWarriors;
        ...
        int totalAttackMin = powerWarrior * numbersOfWarriors + powerArcher * numbersOfWarriors
                + powerHorseman * numbersOfWarriors;
